...
<div class="card product-lifecycle-index">
    <?php if (P::can('product-lifecycle/create')): ?>
...
//            ],
                [
                    ...
                    'visibleButtons' => [
                        'view' => P::can('product-lifecycle/view'),
                        'update' => function ($model) {
                            return P::can('product-lifecycle/update'); // && $model->status < $model::STATUS_SAVED;
                        },
                        'delete' => function ($model) {
                            return P::can('product-lifecycle/delete'); // && $model->status < $model::STATUS_SAVED;
                        }
                    ],
                    'buttons' => [
...
<?= \app\widgets\ModalWindow\ModalWindow::widget([
    ...
    'modal_header' => '<h5>' . Yii::t('app', 'Product Lifecycle') . '</h5>',
