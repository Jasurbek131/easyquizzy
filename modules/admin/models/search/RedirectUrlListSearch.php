...
/**
 * RedirectUrlListSearch represents the model behind the search form of `app\modules\admin\models\RedirectUrlList`.
 */
class RedirectUrlListSearch extends RedirectUrlList
{
    /**
     * {@inheritdoc}
     */
