...
//                                        'visible' => P::can('auth-item/permissions'),
                        ...
                        [
                            ...
                            'visible' => P::can("hr-departments/index") || P::can("hr-employee/index") || P::can("hr-positions/index"),
                            'items' => [
                                [
                                    'label' => Yii::t('app', 'Hr Departments'),
                                    'url' => '/hr/hr-departments/index',
                                    'options' => ['class' => 'nav-item'],
                                    'visible' => P::can("hr-departments/index"),
                                ...
                                [
                                    ...
                                    'visible' =>  P::can("hr-positions/index"),
                        ...
                        [
                            ...
                            'items' => [
                                ...
                                [
                                    'label' => Yii::t('app', 'Stops'),
                                    'url' => '/plm/plm-report/stop',
                                    'options' => ['class' => 'nav-item'],
//                                    'visible' => P::can("plm-report/stop"),
                                    'active' => $controller == 'plm-report' && $action == 'stop',
                                    'template' => '<a href="{url}" class="{linkClass}"><i class="fa fa-chart-area nav-icon"></i><p>{label}</p></a>',
                                ],
                            ],
                        ],
